...
enum _gpio_pins 
{
	...
	kWarpPinSPI_SCK				= GPIO_MAKE_PIN(HW_GPIOA, 9),		/*	Warp kWarpPinSPI_SCK	--> PTA9		(was kWarpPinTPS82740A_CTLEN in Warp v2)		*/
	...
	kWarpPinSPI_MOSI			= GPIO_MAKE_PIN(HW_GPIOA, 8),		/*	Warp KL03_SPI_MOSI	--> PTA8									*/
